...
AI-powered stock market analysis with **news**, **sentiment**, **indicators**, and **trading signals**.  
Built with FastAPI + LangGraph + Streamlit.

**Live Demo:** [UI](https://ai-agent-ui-ojg6.onrender.com) | [API](https://ai-agent-3yvo.onrender.com)

---

## ✨ Features

- Real-time stock analysis with news, sentiment, and technical indicators
- AI-powered Buy/Hold/Sell signals with T+1/T+5 horizons
- Interactive charts with price action and RSI
- Minimalist UI with light/dark theme toggle
- Auto-start backend
...
```bash
# Clone and setup
git clone https://github.com/abuqaiselegant/ai-agent.git
cd ai-agent
python3 -m venv .venv
...
1. Enter a stock symbol (e.g., TSLA, AAPL, GOOGL)
2. Select analysis options (News, Equity, Sentiment, Indicators, Decision)
3. Click "Analyze"
4. View results in tabs: Summary, Chart, News, Sentiment, Indicators, JSON

## 🏗️ Architecture

- **Frontend**: Streamlit single-page app
- **Backend**: FastAPI with LangGraph orchestration
- **Analysis**: News API, yfinance, OpenAI sentiment, technical indicators
...
Fork → Branch → Changes → Test → Pull Request
